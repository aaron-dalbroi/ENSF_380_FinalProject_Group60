...
/**
 * A raccoon class animal. Has specified attributes that dictate how long certain tasks will take.
...
public class Raccoon extends Animal {
    ...
    private final String ANIMAL_SPECIES = "Raccoon";

    public Raccoon(String nickName, int animalID){
